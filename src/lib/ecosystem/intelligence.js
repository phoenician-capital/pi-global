...
export const dossiers = [
  {
    ...
    prompting: {
      ...
      pipeline: [
        "Data collection (SKIP_* flags) — CapIQ Excel then Company Review/PDF",
        "RAG index (Vertex primary when flagged; AS for §5/§11)",
        "Agentic query-gen + RAG prefetch + Perplexity web for §2–8",
        "Sections workflow.py order [2,3,4,5,6,7,8,9,10,12,1,11] — parallel 2∥10, 6∥7; §12 RFW from t0",
        "§8 UE-DCF 8-step + LibreOffice P/V gate (0.3–3.0) + §8.5 comps",
        "Assemble EFS → callback .NET report-completed",
        "Optional H2H / Risk Auditor / Brain mine",
        "UI: Product guides → DD engine → DD sections tab (src/lib/ecosystem/ddSections.js)",
      ],
      services: [
